...
xmpp.on("online", async (address) => {
  ...
  xmpp.send(xml(
    "iq",
    { type: "set", id: "offer1", to: to + "@alumchat.fun" },
    xml(
      "si",
      {
  ...
  //   xml(
  //     "iq",
  //     { type: "get", from: address, to: 'conference.alumchat.fun', id: "items1" },
  //     xml(
  //       "query",
  ...
  await xmpp.send(
    xml(
      "iq",
      { from: address, to: 'testing@conference.alumchat.fun', type: "get"},
      xml(
        "query",
